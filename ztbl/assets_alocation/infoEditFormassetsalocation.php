...
if ($dbSuccess) {
       ...
       if($ID ==0){
           ...
           // If nothing is selected
            ...
            header('Location:infoEditassetsalocation.php');
   ...
   // }
    ...
    echo '<h2 style="font-family: arial, helvetica, sans-serif;" >
        ...
        //      FORM postInfo User 
        echo '<form name="postSite" action="infoUpdateassetsalocation.php" method="post">';
         
                
                echo '
                <table>
                    <tr>
                        <td>Assets Alocation Id</td>
                        <td><input type="text" name="assets_alocation_id" value="'.$ID.'"/></td>
                    </tr>
                    <tr>
                        <td>PP Number</td>
    ...
    echo "<br><br>";
echo '<a href="infoEditassetsalocation.php">Edit another Site</a>';
echo "<br><br>";
