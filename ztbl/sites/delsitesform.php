...
if ($dbSuccess) {
       ...
       if($ID ==0){
           ...
           // If nothing is selected
            ...
            header('Location:delsitesform.php');
   ...
   // }
    ...
    echo '<h2 style="font-family: arial, helvetica, sans-serif;" >
        ...
        //      FORM postInfo User 
        echo '<form name="postContact" action="delsites.php" method="post">';
         
                echo '<td>Site Id</td>
                <input type="text" name="site_id" value="'.$ID.'"/>';
                echo '
                <table>
                    <tr>
                        <td>Site Name</td>
    ...
    echo '<a href="http://rohansaeedt/hadiyah/ztbl/index.html">Back to Home Page </a>';
    echo "<br><br>";
echo '<a href="selectsitesdel.php">Delete another sites</a>';
echo "<br><br>";
